...
public final class Setup {
    ...
    static void setupResearches() {
        addResearch("Weapons of Mass Destruction", "大規模殺傷性武器", 70, Items.NUCLEAR_BOMB, Items.BOOMINATOR_9000);
    ...
    private static void addResearch(String id, String name, int xp, SlimefunItemStack... items) {
        Research research = new Research(
            SlimefunWarfare.inst().getKey(id.toLowerCase(Locale.ROOT).replace(' ', '_')),
            researchId++,
            name,
            xp
        );
